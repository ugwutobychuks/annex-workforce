  ...
  return (
    <div className="space-y-8">
      <header className="flex items-start justify-between gap-4">
        <div>
          <div className="text-xs uppercase tracking-[0.18em] text-stone-500 mb-2">EOR contracts</div>
      ...
      {contracts?.length === 0 ? (
        <div className="card text-center py-16 text-stone-500">
          <Building2 className="w-10 h-10 mx-auto mb-3 text-stone-300" />
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    <div>
                      <div className="text-xs uppercase tracking-wider text-stone-500">Salary</div>
                      <div className="font-mono mt-1">{formatNaira(c.monthlySalary)} / mo</div>
                    </div>
                    <div>
                      <div className="text-xs uppercase tracking-wider text-stone-500">Mgmt fee</div>
                      <div className="font-mono mt-1">{formatNaira(c.managementFee)}</div>
                    </div>
                    <div>
                      <div className="text-xs uppercase tracking-wider text-stone-500">Currency</div>
