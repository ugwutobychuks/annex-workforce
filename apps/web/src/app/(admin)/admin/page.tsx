...
export default function AdminOverviewPage() {
  ...
  return (
    <div className="space-y-10">
      <header>
        <div className="text-xs uppercase tracking-[0.18em] text-slate-500 mb-2">Admin</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/admin/verification" className="card hover:border-brand-300 transition-colors">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs uppercase tracking-wider text-slate-500">Verification queue</span>
        ...
        <Link href="/admin/users" className="card hover:border-brand-300 transition-colors">
          <div className="flex items-center justify-between mb-3">
        ...
        <div className="card">
          <div className="text-xs uppercase tracking-wider text-slate-500 mb-3">Platform health</div>
      ...
      {queue?.items?.length ? (
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/verification" className="text-sm text-brand-700 hover:underline flex items-center gap-1">
